...
from .conversations_history import (
    fetch_conversations_history_and_convert_to_openai_sequence,
)
...
async def ask_openai(*, event, say, app):
    ...
    reply_ts = reply["ts"]
    history = await fetch_conversations_history_and_convert_to_openai_sequence(
        client=app.client, channel_id=channel
    )  # TODO: retrieval is the name of the game. Enhance this with proper search.
